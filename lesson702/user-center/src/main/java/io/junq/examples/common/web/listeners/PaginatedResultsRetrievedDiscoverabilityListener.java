...
import static io.junq.examples.common.util.LinkUtil.REL_FIRST;
import static io.junq.examples.common.util.LinkUtil.REL_LAST;
import static io.junq.examples.common.util.LinkUtil.REL_NEXT;
import static io.junq.examples.common.util.LinkUtil.REL_PREV;
import static io.junq.examples.common.util.LinkUtil.createLinkHeader;
...
class PaginatedResultsRetrievedDiscoverabilityListener implements ApplicationListener<PaginatedResultsRetrievedEvent> {
    ...
    protected void plural(final UriComponentsBuilder uriBuilder, final Class clazz) {
        ...
        uriBuilder.path(UserCenterMapping.BASE + PATH_SEP + resourceName);
    }
