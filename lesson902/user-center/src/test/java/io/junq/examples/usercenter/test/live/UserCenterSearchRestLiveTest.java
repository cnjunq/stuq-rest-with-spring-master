...
import io.junq.examples.test.common.web.AbstractSearchLiveTest;
...
public abstract class UserCenterSearchRestLiveTest<T extends INameableDto> extends AbstractSearchLiveTest<T> {

	public UserCenterSearchRestLiveTest() {
		super();
	}
